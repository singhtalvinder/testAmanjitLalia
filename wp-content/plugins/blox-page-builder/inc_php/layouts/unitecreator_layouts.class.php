...
class UniteCreatorLayoutsWork extends UniteElementsBaseUC{
	...
	private function a________GET_LAYOUTS________(){}
	...
	private function a________OTHER_GETTERS________(){}
	...
	private function a________OPERATIONS________(){}
	...
	public function updateLayoutFromData($data){
		...
		if(empty($layoutID)){
			...
			if($isTitleOnly == true){
				...
				$message = __("Title Saved",BLOXBUILDER_TEXTDOMAIN);
