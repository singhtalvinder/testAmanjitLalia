...
class UniteCreatorViewGeneralSettingsProvider extends UniteCreatorViewGeneralSettings{
	...
	protected function drawAdditionalTabs(){
		...
		?>
			<a data-contentid="uc_tab_developers" href="javascript:void(0)" onfocus="this.blur()"> <?php _e("Theme Developers", BLOXBUILDER_TEXTDOMAIN)?></a>
		<?php
	...
	*/
	protected function drawAdditionalTabsContent(){
		...
		<div id="uc_tab_developers" class="uc-tab-content" style="display:none">
			...
			If you put the Blox Page Builder as part of your theme and want
...
/**
* Set Blox Page Builder addons install folder. 
...
add_filter(&quot;blox_path_theme_addons&quot;, &quot;set_addons_install_path_<?php echo $randomString?>&quot;);
</textarea>
