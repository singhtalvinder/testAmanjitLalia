...
class UniteTableUC extends HtmlOutputBaseUC{
	...
	public function putFilterCategory(){
		...
		$html = "<span class='uc-table-top-filter-title'>".__("Filter Category", BLOXBUILDER_TEXTDOMAIN)."</span>";
	...
	private function getPaginationHtml(){
		...
		if($total_pages > 0 && $total_pages != 1 && $current_page <= $total_pages){ //verify total pages and current page number
			...
			if($current_page > 1 && $isShowExtras == true){
				...
				$titleFirst = __("First", BLOXBUILDER_TEXTDOMAIN);
				$titlePrev = __("Previous", BLOXBUILDER_TEXTDOMAIN);
			...
			if($current_page < $total_pages && $isShowExtras == true){
				...
				$titleNext = __("Next Page", BLOXBUILDER_TEXTDOMAIN);
				$titleLast = __("Last Page", BLOXBUILDER_TEXTDOMAIN);
	...
	public function putSearchForm($buttonText = "", $clearText = "", $putByDefault = true){
		...
		if(empty($buttonText))
			$buttonText = __("Search", BLOXBUILDER_TEXTDOMAIN);
		
		if(empty($clearText))
			$clearText = __("Clear", BLOXBUILDER_TEXTDOMAIN);
